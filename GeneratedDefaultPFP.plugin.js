/**
 * @name GeneratedDefaultProfilePics
 * @author DevilBro
 * @authorId 278543574059057154
 * @version 0.0.1
 * @description Generates an image based on a users ID, so you can easily distinguish between
...
module.exports = ((_) => {
  ...
  return (window.Lightcord && !Node.prototype.isPrototypeOf(window.Lightcord)) ||
    ...
    : (([Plugin, BDFDB]) => {
        ...
        return class GeneratedDefaultPFP extends Plugin {
          onLoad() {
            this.defaults = {
              types: {
          ...
          onStart() {
            BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.MessageAuthorUtils, ["default", "getMessageAuthor"], {
              after: (e) => {
                if (this.settings.places.chatWindow && e.methodArguments[0]?.author) {
            ...
            let searchGroupData = BDFDB.ObjectUtils.get(
              BDFDB.ModuleUtils.findByName("SearchPopoutComponent", false),
              "exports.GroupData"
            );
            if (BDFDB.ObjectUtils.is(searchGroupData)) {
              BDFDB.PatchUtils.patch(this, searchGroupData.FILTER_FROM, "component", {
                after: (e) => {
                  if (typeof e.returnValue.props.renderResult == "function") {
                    ...
                    e.returnValue.props.renderResult = (...args) => {
                      ...
                      this.processSearchPopoutUserResult({
              ...
              BDFDB.PatchUtils.patch(this, searchGroupData.FILTER_MENTIONS, "component", {
                after: (e) => {
                  if (typeof e.returnValue.props.renderResult == "function") {
                    let renderResult = e.returnValue.props.renderResult;
                    e.returnValue.props.renderResult = (...args) => {
            ...
            if (
              BDFDB.LibraryModules.AutocompleteOptions &&
              BDFDB.LibraryModules.AutocompleteOptions.AUTOCOMPLETE_OPTIONS
            )
              BDFDB.PatchUtils.patch(
                this,
                BDFDB.LibraryModules.AutocompleteOptions.AUTOCOMPLETE_OPTIONS.MENTIONS,
                "queryResults",
                {
                  after: (e) => {
                    let userArray = [];
                    for (let id in changedUsers)
                      if (changedUsers[id] && changedUsers[id].name) {
                        let user = BDFDB.LibraryModules.UserStore.getUser(id);
                        let member =
                          user &&
                          e.methodArguments[0].guild_id &&
                          BDFDB.LibraryModules.MemberStore.getMember(e.methodArguments[0].guild_id, id);
                        if (user && (e.methodArguments[0].recipients.includes(id) || member))
                          userArray.push(
                            Object.assign(
                              {
                    ...
                    userArray = BDFDB.ArrayUtils.keySort(
                      userArray.filter(
                        (n) =>
                          e.returnValue.results.users.every((comp) => comp.user.id != n.user.id) &&
                          n.comparator.toLowerCase().indexOf(e.methodArguments[2].toLowerCase()) != -1
                      ),
                      "lowerCaseName"
                    );
                    e.returnValue.results.users = []
                      .concat(
                        e.returnValue.results.users,
                        userArray.map((n) => ({ user: n.user }))
                      )
                      .slice(0, BDFDB.DiscordConstants.MAX_AUTOCOMPLETE_RESULTS);
                  },
                }
              );

            BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.IconUtils, "getUserBannerURL", {
              instead: (e) => {
            ...
            BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.BannerUtils, "getUserBannerURLForContext", {
              instead: (e) => {
            ...
            BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.StatusMetaUtils, "findActivity", {
              after: (e) => {
                let data = changedUsers[e.methodArguments[0]];
                if (
                  data &&
                  (data.removeStatus || data.status || data.statusEmoji) &&
                  ((e.returnValue && e.returnValue.type === BDFDB.DiscordConstants.ActivityTypes.CUSTOM_STATUS) ||
                    (!e.returnValue &&
                      e.methodArguments[1] &&
                      e.methodArguments[1].toString().indexOf("type===") > -1 &&
                      e.methodArguments[1].toString().indexOf("CUSTOM_STATUS") > -1))
                )
                  return this.createCustomStatus(changedUsers[e.methodArguments[0]]);
              },
            });
                ...
                settingsItems.push(
                  BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
                    ...
                    label: BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.Flex, {
                      children: !Object.keys(changedUsers).length
                        ? BDFDB.LanguageUtils.LanguageStrings.NONE
                        : Object.keys(changedUsers)
                            .filter(BDFDB.LibraryModules.UserStore.getUser)
                            .map((id) =>
                              BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TooltipContainer, {
                                ...
                                children: BDFDB.ReactUtils.createElement(
                                  BDFDB.LibraryComponents.AvatarComponents.default,
                                  {
                                    ...
                                    onClick: (_) =>
                                      this.openUserSettingsModal(BDFDB.LibraryModules.UserStore.getUser(id)),
                                  }
                                ),
                              })
                            ),
          ...
          onUserContextMenu(e) {
            if (e.instance.props.user) {
              ...
              if (userName != e.instance.props.user.username && this.settings.places.contextMenu) {
                ...
                if (kickIndex > -1)
                  kickChilden[kickIndex].props.label = BDFDB.LanguageUtils.LanguageStringsFormat("KICK_USER", userName);
                let [banChilden, banIndex] = BDFDB.ContextMenuUtils.findItem(e.returnvalue, { id: "ban" });
                if (banIndex > -1)
                  banChilden[banIndex].props.label = BDFDB.LanguageUtils.LanguageStringsFormat("BAN_USER", userName);
                let [muteChilden, muteIndex] = BDFDB.ContextMenuUtils.findItem(e.returnvalue, { id: "mute-channel" });
                if (muteIndex > -1)
                  muteChilden[muteIndex].props.label = BDFDB.LanguageUtils.LanguageStringsFormat(
                    "MUTE_CHANNEL",
                    `@${userName}`
                  );
                let [unmuteChilden, unmuteIndex] = BDFDB.ContextMenuUtils.findItem(e.returnvalue, {
                  id: "unmute-channel",
                });
                if (unmuteIndex > -1)
                  unmuteChilden[unmuteIndex].props.label = BDFDB.LanguageUtils.LanguageStringsFormat(
                    "UNMUTE_CHANNEL",
                    `@${userName}`
                  );
              }
          ...
          processChannelEditorContainer(e) {
            if (
              ...
              e.instance.props.channel.isDM() &&
              e.instance.props.type == BDFDB.DiscordConstants.TextareaTypes.NORMAL &&
              this.settings.places.chatTextarea
            ) {
              let user = BDFDB.LibraryModules.UserStore.getUser(e.instance.props.channel.recipients[0]);
              if (user)
                e.instance.props.placeholder = BDFDB.LanguageUtils.LanguageStringsFormat(
          ...
          processNameTag(e) {
            if (
              ...
              (e.instance.props.className || e.instance.props.usernameClass)
            ) {
              let change = false,
                guildId = null;
              ...
              switch (e.instance.props.usernameClass) {
                case BDFDB.disCN.messagereactionsmodalusername:
                  change =
                    ...
                    !BDFDB.LibraryModules.MemberStore.getNick(
                      BDFDB.LibraryModules.LastGuildStore.getGuildId(),
              ...
              if (change) {
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.username]],
                });
                if (userName)
                ...
                if (tagClass)
                  this.injectBadge(e.returnvalue.props.children, e.instance.props.user.id, guildId, 2, {
                    tagClass: tagClass,
          ...
          processFocusRing(e) {
            if (e.returnvalue && e.returnvalue.props.className) {
              let change,
                ...
                modify = {};
              if (
                this.settings.places.chatWindow &&
                e.returnvalue.props.className.indexOf(BDFDB.disCN.messageswelcomethreadcreator) > -1
              ) {
                change = true;
              ...
              if (change && userId) {
                if (changedUsers[userId]) {
                  let name = nameClass
                    ? BDFDB.ReactUtils.findChild(e.returnvalue, { props: [["className", nameClass]] })
                    : e.returnvalue;
                  if (name) {
          ...
          processUserPopoutContainer(e) {
            if (
              ...
              this.settings.places.userPopout &&
              changedUsers[e.returnvalue.props.user.id]
            )
              e.returnvalue.props.user = this.getUserData(e.returnvalue.props.user.id, true, true);
          }
              ...
              if (!e.returnvalue) {
                ...
                if (data.color1 || data.color2 || data.tag) {
                  let [children, index] = BDFDB.ReactUtils.findParent(e.returnvalue, {
                    props: [["className", BDFDB.disCN.userpopoutheadernickname]],
                  });
                  if (index > -1) {
                    ...
                    if (!BDFDB.ArrayUtils.is(children[index].props.children))
                      children[index].props.children = [children[index].props.children].flat(10);
                    this.injectBadge(
            ...
            if (this.settings.places.mutualFriends) {
              ...
              if (index > -1)
                for (let row of children)
                  if (row && row.props && row.props.user) row.props.user = this.getUserData(row.props.user.id);
            }
          }
            ...
            if (e.instance.props.user && this.settings.places.friendList) {
              ...
              if (BDFDB.ReactUtils.isValidElement(e.instance.props.subText)) {
                ...
                if (data && (data.removeStatus || data.status || data.statusEmoji)) {
                  e.instance.props.subText.props.activities = []
                    .concat(e.instance.props.subText.props.activities)
                    .filter((n) => n && n.type != BDFDB.DiscordConstants.ActivityTypes.CUSTOM_STATUS);
                ...
                if (child && child.props && child.props.party) {
                  if (child.type && child.type.displayName == "NowPlayingHeader") {
                    ...
                    child.type = (...args) => {
                      ...
                      if (
                        BDFDB.ObjectUtils.get(returnValue, "props.priorityUser.user.username") ==
                        returnValue.props.title
                      ) {
                        returnValue.props.title = BDFDB.ReactUtils.createElement("span", {
                          children: returnValue.props.title,
                        });
                  ...
                  if (child.props.party.partiedMembers)
                    for (let i in child.props.party.partiedMembers)
                      if (child.props.party.partiedMembers[i])
                        child.props.party.partiedMembers[i] = this.getUserData(child.props.party.partiedMembers[i].id);
                  if (child.props.party.priorityMembers)
                    for (let i in child.props.party.priorityMembers)
                      if (child.props.party.priorityMembers[i])
                        child.props.party.priorityMembers[i] = Object.assign({}, child.props.party.priorityMembers[i], {
                          user: this.getUserData(child.props.party.priorityMembers[i].user.id),
                        });
                  if (child.props.party.voiceChannels)
                    for (let i in child.props.party.voiceChannels)
                      if (child.props.party.voiceChannels[i])
                        child.props.party.voiceChannels[i] = Object.assign({}, child.props.party.voiceChannels[i], {
                          members: []
                            .concat(child.props.party.voiceChannels[i].members)
                            .map((user) => this.getUserData(user.id)),
                        });
                }
          }
            ...
            if (e.instance.props.user && this.settings.places.voiceChat) {
              if (!e.returnvalue) {
                ...
                if (data && data.name) {
                  ...
                  e.instance.props.nick =
                    this.getUserNick(e.instance.props.user.id, e.instance.props.nick) || e.instance.props.nick;
                }
              } else {
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.voicename]],
                });
          ...
          processRTCConnectionVoiceUsers(e) {
            if (e.instance.props.voiceStates && this.settings.places.voiceChat)
              for (let i in e.instance.props.voiceStates) {
                ...
                if (data) {
                  ...
                  e.instance.props.voiceStates[i].nick =
                    this.getUserNick(
                      e.instance.props.voiceStates[i].user.id,
                      e.instance.props.voiceStates[i].member.nick
                    ) || e.instance.props.voiceStates[i].nick;
                }
              }
          }
          ...
          processAccount(e) {
            if (e.instance.props.currentUser && this.settings.places.userAccount) {
              ...
              if (!e.returnvalue) {
                ...
                if (data && (data.removeStatus || data.status || data.statusEmoji))
                  e.instance.props.customStatusActivity = this.createCustomStatus(data);
              } else {
                if (data && (data.color1 || data.color2)) {
                  ...
                  if (tooltip && typeof tooltip.props.children == "function") {
                    ...
                    tooltip.props.children = BDFDB.TimeUtils.suppress(
                      (...args) => {
          ...
          processMessage(e) {
            if (this.settings.places.chatWindow) {
              ...
              if (header?.props?.message) {
                if (true) {
                  let message = new BDFDB.DiscordObjects.Message(
                    Object.assign({}, header.props.message, {
                      author: this.getUserData(
                        header.props.message.author.id,
                        true,
                        false,
                        header.props.message.author
                      ),
                    })
                  );
              ...
              if (
                ...
                repliedMessage.props.children &&
                repliedMessage.props.children.props &&
                repliedMessage.props.children.props.referencedMessage &&
                repliedMessage.props.children.props.referencedMessage.message &&
                this.shouldChangeInChat(repliedMessage.props.children.props.referencedMessage.message.channel_id)
              ) {
                    ...
                    (data.color1 &&
                      ...
                      (
                        BDFDB.LibraryModules.MemberStore.getMember(
                          (BDFDB.LibraryModules.ChannelStore.getChannel(referenceMessage.channel_id) || {}).guild_id,
                          header.props.message.author.id
                        ) || {}
                      ).colorString) ||
                    data.color1;
                  let message = new BDFDB.DiscordObjects.Message(
                    Object.assign({}, referenceMessage, {
                      author: this.getUserData(referenceMessage.author.id, true, false, referenceMessage.author),
                    })
                  );
                  if (color1)
                    message.colorString = BDFDB.ColorUtils.convert(
                      BDFDB.ObjectUtils.is(color1) ? color1[0] : color1,
                      "HEX"
                    );
                  repliedMessage.props.children.props.referencedMessage = Object.assign(
                    {},
                    repliedMessage.props.children.props.referencedMessage,
                    { message: message }
                  );
          ...
          processMessageUsername(e) {
            if (
              ...
              !this.settings.places.chatWindow ||
              !this.shouldChangeInChat(e.instance.props.message.channel_id)
            )
              return;
            ...
            if (!e.returnvalue) {
              let color1 =
                (data.color1 &&
                  ...
                  (
                    BDFDB.LibraryModules.MemberStore.getMember(
                      (BDFDB.LibraryModules.ChannelStore.getChannel(e.instance.props.message.channel_id) || {})
                        .guild_id,
                      author.id
                    ) || {}
                  ).colorString) ||
              ...
              if (e.instance.props.userOverride) e.instance.props.userOverride = this.getUserData(author.id);
                ...
                let message = new BDFDB.DiscordObjects.Message(
                  Object.assign({}, e.instance.props.message, {
                    author: this.getUserData(author.id, true, false, author),
                  })
                );
              ...
              let member = BDFDB.LibraryModules.MemberStore.getMember(
                (BDFDB.LibraryModules.ChannelStore.getChannel(e.instance.props.message.channel_id) || {}).guild_id,
                author.id
              );
              e.instance.props.author = Object.assign({}, e.instance.props.author, {
                nick:
                  this.getUserNick(e.instance.props.author.id, member && member.nick) || e.instance.props.author.nick,
              ...
              if (data.color1 || data.color2) {
                let messageUsername = BDFDB.ReactUtils.findChild(e.returnvalue.props.children, {
                  name: "Popout",
                  props: [["className", BDFDB.disCN.messageusername]],
                });
                if (messageUsername) {
                  if (messageUsername.props && typeof messageUsername.props.children == "function") {
                    let renderChildren = messageUsername.props.children;
                    messageUsername.props.children = BDFDB.TimeUtils.suppress(
                      (...args) => {
                        let renderedChildren = renderChildren(...args);
                        this.changeUserColor(renderedChildren, author.id, {
                          guildId: (
                            BDFDB.LibraryModules.ChannelStore.getChannel(e.instance.props.message.channel_id) || {}
                          ).guild_id,
                        });
                    ...
                    this.changeUserColor(messageUsername, author.id, {
                      guildId: (BDFDB.LibraryModules.ChannelStore.getChannel(e.instance.props.message.channel_id) || {})
                        .guild_id,
                    });
                }
              }
          ...
          processMessageContent(e) {
            if (
              ...
              if (!e.returnvalue) {
                if (
                  e.instance.props.message.type != BDFDB.DiscordConstants.MessageTypes.DEFAULT &&
                  e.instance.props.message.type != BDFDB.DiscordConstants.MessageTypes.REPLY
                ) {
                  let message = new BDFDB.DiscordObjects.Message(
                    Object.assign({}, e.instance.props.message, {
                      author: this.getUserData(
                        e.instance.props.message.author.id,
                        true,
                        false,
                ...
                let messageColor =
                  data &&
                  (data.color5 ||
                    (BDFDB.BDUtils.getSettings(BDFDB.BDUtils.settingsIds.coloredText) &&
                      ((data.color1 &&
                        data.useRoleColor &&
                        (
                          BDFDB.LibraryModules.MemberStore.getMember(
                        ...
                        data.color1)));
                if (messageColor) {
                  if (BDFDB.ObjectUtils.is(messageColor))
                    e.returnvalue.props.children = BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.TextGradientElement,
                      {
                    ...
                    e.returnvalue.props.children = BDFDB.ReactUtils.createElement("span", {
                      style: Object.assign({}, e.returnvalue.props.style, {
                        color: BDFDB.ColorUtils.convert(messageColor, "RGBA"),
                      }),
                      children: e.returnvalue.props.children,
                    });
                }
          ...
          processThreadMessageAccessoryMessage(e) {
            if (
              ...
              e.instance.props.message = new BDFDB.DiscordObjects.Message(
                Object.assign({}, e.instance.props.message, {
                  author: this.getUserData(e.instance.props.message.author.id),
                })
              );
          }
          ...
          processReaction(e) {
            ...
            if (e.instance.props.reactions && e.instance.props.reactions.length) {
              ...
              let users = e.instance.props.reactions
                .filter((user) => !BDFDB.LibraryModules.RelationshipStore.isBlocked(user.id))
                .slice(0, 3)
                .map(
                  (user) =>
                    (changedUsers[user.id] && changedUsers[user.id].name) ||
                    (guildId && BDFDB.LibraryModules.MemberStore.getNick(guildId, user.id)) ||
                    user.username
                )
                .filter((user) => user);
              if (users.length) {
                ...
                e.returnvalue.props.text =
                  users.length == 1
                    ? others > 0
                      ? BDFDB.LanguageUtils.LanguageStringsFormat("REACTION_TOOLTIP_1_N", users[0], others, emojiName)
              ...
              BDFDB.LibraryModules.ReactionUtils.getReactions(
                e.instance.props.message.channel_id,
                e.instance.props.message.id,
                e.instance.props.emoji
              ).then((reactions) => {
          ...
          processReactorsComponent(e) {
            if (
              ...
              this.shouldChangeInChat(e.instance.props.channel.id)
            ) {
              if (!e.returnvalue) {
                for (let i in e.instance.props.reactors)
                  if (
                    !BDFDB.LibraryModules.MemberStore.getNick(e.instance.props.guildId, e.instance.props.reactors[i].id)
                  )
                    e.instance.props.reactors[i] = this.getUserData(
                      e.instance.props.reactors[i].id,
                      true,
                      false,
                      e.instance.props.reactors[i]
                    );
              } else {
                ...
                e.returnvalue.props.renderRow = (...args) => {
                  ...
                  if (row && row.props && row.props.user && changedUsers[row.props.user.id]) {
                    ...
                    row.type = (...args2) => {
                      ...
                      let nickName =
                        BDFDB.LibraryModules.MemberStore.getNick(row.props.guildId, row.props.user.id) &&
                        BDFDB.ReactUtils.findChild(result, {
                          props: [["className", BDFDB.disCN.messagereactionsmodalnickname]],
                        });
                      if (nickName) {
                        if (changedUsers[row.props.user.id].name)
                          BDFDB.ReactUtils.setChild(nickName, changedUsers[row.props.user.id].name);
          ...
          processUserMention(e) {
            if (
              ...
              changedUsers[e.instance.props.userId] &&
              this.shouldChangeInChat(e.instance.props.channelId)
            ) {
              if (typeof e.returnvalue.props.children == "function") {
                ...
                e.returnvalue.props.children = BDFDB.TimeUtils.suppress(
                  (...args) => {
                    ...
                    this.changeMention(
                      BDFDB.ReactUtils.findChild(children, { name: "Mention" }),
                      changedUsers[e.instance.props.userId]
                    );
                    return children;
                  },
                ...
                this.changeMention(
                  BDFDB.ReactUtils.findChild(e.returnvalue, { name: "Mention" }),
                  changedUsers[e.instance.props.userId]
                );
            }
          }
          ...
          processRichUserMention(e) {
            if (
              e.instance.props.id &&
              this.settings.places.mentions &&
              changedUsers[e.instance.props.id] &&
              this.shouldChangeInChat(e.instance.props.channel && e.instance.props.channel.id)
            ) {
              ...
              if (tooltipChildren) {
                if (tooltipChildren[0] && tooltipChildren[0].props && tooltipChildren[0].props.user)
                  tooltipChildren[0].props.user = this.getUserData(tooltipChildren[0].props.user.id);
          ...
          changeMention(mention, data) {
            ...
            if (data.name) {
              const changeMentionName = (child, name) => {
                ...
                else if (child.props && typeof child.props.children == "string" && child.props.children[0] == "@")
                  child.props.children = "@" + data.name;
                else if (child.props && BDFDB.ArrayUtils.is(child.props.children))
                  changeMentionName(child.props.children);
              };
              changeMentionName(mention);
            }
            if (data.color1)
              mention.props.color = BDFDB.ColorUtils.convert(
                BDFDB.ObjectUtils.is(data.color1) ? data.color1[0] : data.color1,
                "INT"
              );
          }
          ...
          processChannelReply(e) {
            if (
              e.instance.props.reply &&
              e.instance.props.reply.message &&
              this.settings.places.chatWindow &&
              this.shouldChangeInChat(e.instance.props.reply.message.channel_id)
            ) {
              if (!e.returnvalue) {
                let message = new BDFDB.DiscordObjects.Message(
                  Object.assign({}, e.instance.props.reply.message, {
                    author: this.getUserData(e.instance.props.reply.message.author.id),
                  })
                );
                  ...
                  let color1 =
                    (data.color1 &&
                      ...
                      (
                        BDFDB.LibraryModules.MemberStore.getMember(
                          (
                            BDFDB.LibraryModules.ChannelStore.getChannel(e.instance.props.reply.message.channel_id) ||
                            {}
                          ).guild_id,
                          e.instance.props.reply.message.author.id
                        ) || {}
                      ).colorString) ||
                    data.color1;
                  if (color1)
                ...
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.messagereplyname]],
                });
              ...
              if (!e.returnvalue) {
                ...
                if (data) {
                  ...
                  if (data.removeStatus || data.status || data.statusEmoji) {
                    e.instance.props.activities = []
                      .concat(e.instance.props.activities)
                      .filter((n) => n.type != BDFDB.DiscordConstants.ActivityTypes.CUSTOM_STATUS);
                    let activity = this.createCustomStatus(data);
                    if (activity) e.instance.props.activities.unshift(activity);
                  }
                }
              } else {
                this.changeUserColor(e.returnvalue.props.name, e.instance.props.user.id, {
                  changeBackground: true,
                  guildId: e.instance.props.channel.guild_id,
                });
                this.injectBadge(
                  BDFDB.ObjectUtils.get(e.returnvalue, "props.decorators.props.children"),
                  e.instance.props.user.id,
                  BDFDB.LibraryModules.LastGuildStore.getGuildId(),
                  2,
                  {
          ...
          processAuditLogs(e) {
            if (e.instance.props.logs && this.settings.places.guildSettings) {
              if (!BDFDB.PatchUtils.isPatched(this, e.instance, "renderUserQuickSelectItem"))
                BDFDB.PatchUtils.patch(
                  this,
                  e.instance,
                  "renderUserQuickSelectItem",
                  {
                    after: (e2) => {
                      if (
                        ...
                        e2.methodArguments[0].user &&
                        changedUsers[e2.methodArguments[0].user.id]
                      ) {
                        let userName = BDFDB.ReactUtils.findChild(e2.returnValue, {
                          props: [["children", e2.methodArguments[0].label]],
                        });
                        if (userName) {
                          if (changedUsers[e2.methodArguments[0].user.id].name)
                            userName.props.children = changedUsers[e2.methodArguments[0].user.id].name;
                          this.changeUserColor(userName, e2.methodArguments[0].user.id);
                        }
                        let avatar = BDFDB.ReactUtils.findChild(e2.returnValue, {
                          props: [["className", BDFDB.disCN.auditlogpopoutavatar]],
                        });
          ...
          processGuildSettingsAuditLogEntry(e) {
            if (e.instance.props.log && this.settings.places.guildSettings) {
              ...
              if (e.instance.props.log.target && e.instance.props.log.targetType == "USER")
                e.instance.props.log.target = this.getUserData(e.instance.props.log.target.id);
            }
          }
          ...
          processGuildSettingsEmoji(e) {
            if (BDFDB.ArrayUtils.is(e.instance.props.emojis) && this.settings.places.guildSettings) {
              ...
              for (let i in e.instance.props.emojis)
                e.instance.props.emojis[i] = Object.assign({}, e.instance.props.emojis[i], {
                  user: this.getUserData(e.instance.props.emojis[i].user.id),
                });
            }
          }
          ...
          processSettingsInvites(e) {
            if (BDFDB.ObjectUtils.is(e.instance.props.invites) && this.settings.places.guildSettings) {
              ...
              for (let id in e.instance.props.invites)
                e.instance.props.invites[id] = new BDFDB.DiscordObjects.Invite(
                  Object.assign({}, e.instance.props.invites[id], {
                    inviter: this.getUserData(e.instance.props.invites[id].inviter.id),
                  })
                );
            }
          }
          ...
          processGuildSettingsBans(e) {
            if (BDFDB.ObjectUtils.is(e.instance.props.bans) && this.settings.places.guildSettings) {
              ...
              for (let id in e.instance.props.bans)
                e.instance.props.bans[id] = Object.assign({}, e.instance.props.bans[id], {
                  user: this.getUserData(e.instance.props.bans[id].user.id),
                });
            }
          }
          ...
          processInvitationCard(e) {
            if (e.instance.props.user && this.settings.places.inviteList) {
              if (!e.returnvalue) e.instance.props.user = this.getUserData(e.instance.props.user.id);
                ...
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.invitemodalinviterowname]],
                });
                if (userName) this.changeUserColor(userName, e.instance.props.user.id);
              }
            }
          ...
          processInviteModalUserRow(e) {
            if (e.instance.props.user && this.settings.places.inviteList) {
              let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                props: [["className", BDFDB.disCN.searchpopoutddmaddnickname]],
              });
              if (userName) this.changeUserColor(userName, e.instance.props.user.id);
            }
          }
          ...
          processTypingUsers(e) {
            if (
              BDFDB.ObjectUtils.is(e.instance.props.typingUsers) &&
              Object.keys(e.instance.props.typingUsers).length &&
              this.settings.places.typing
            ) {
              let users = Object.keys(e.instance.props.typingUsers)
                .filter((id) => id != BDFDB.UserUtils.me.id)
                .filter((id) => !BDFDB.LibraryModules.RelationshipStore.isBlocked(id))
                .map((id) => BDFDB.LibraryModules.UserStore.getUser(id))
                .filter((user) => user);
              if (users.length) {
                let typingText = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.typingtext]],
                });
                if (typingText && BDFDB.ArrayUtils.is(typingText.props.children))
                  for (let child of typingText.props.children)
          ...
          processDirectMessage(e) {
            if (e.instance.props.channel && e.instance.props.channel.isDM() && this.settings.places.recentDms) {
              ...
              let avatar = BDFDB.ReactUtils.findChild(e.returnvalue, {
                filter: (c) => c && c.props && !isNaN(parseInt(c.props.id)),
              });
              if (avatar && typeof avatar.props.children == "function") {
                let childrenRender = avatar.props.children;
                avatar.props.children = BDFDB.TimeUtils.suppress(
                  (...args) => {
                    let renderedChildren = childrenRender(...args);
                    if (renderedChildren && renderedChildren.props)
                      renderedChildren.props.icon = this.getUserAvatar(recipientId);
                    return renderedChildren;
                  },
                  "",
                  this
          ...
          _processPrivateChannel(instance, returnvalue) {
            returnvalue.props.name = BDFDB.ReactUtils.createElement("span", {
              children: this.getUserData(instance.props.user.id).username,
            });
            this.changeUserColor(returnvalue.props.name, instance.props.user.id, {
              modify: BDFDB.ObjectUtils.extract(
                Object.assign({}, instance.props, instance.state),
                "hovered",
                "selected",
                "hasUnreadMessages",
                "muted"
          ...
          processQuickSwitchUserResult(e) {
            if (e.instance.props.user && this.settings.places.quickSwitcher) {
              if (!e.returnvalue) e.instance.props.user = this.getUserData(e.instance.props.user.id);
                ...
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.quickswitchresultmatch]],
                });
                if (userName) {
                  let data = changedUsers[e.instance.props.user.id];
                  if (data && data.name) userName.props.children = data.name;
                  this.changeUserColor(userName, e.instance.props.user.id, {
                    modify: BDFDB.ObjectUtils.extract(e.instance.props, "focused", "unread", "mentions"),
                  });
                }
              }
            }
          ...
          processSearchPopoutComponent(e) {
            if (
              BDFDB.ArrayUtils.is(BDFDB.ObjectUtils.get(e, "instance.props.resultsState.autocompletes")) &&
              this.settings.places.searchPopout
            ) {
              for (let autocomplete of e.instance.props.resultsState.autocompletes)
                if (autocomplete && BDFDB.ArrayUtils.is(autocomplete.results))
                  for (let result of autocomplete.results)
                    if (result.user) result.user = this.getUserData(result.user.id);
            }
          }
          ...
          processSearchPopoutUserResult(e) {
            if (e.instance.props.result && e.instance.props.result.user && this.settings.places.searchPopout) {
              let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                props: [["className", BDFDB.disCN.searchpopoutdisplayednick]],
              });
              if (userName) {
              ...
              let avatar = BDFDB.ReactUtils.findChild(e.returnvalue, {
                props: [["className", BDFDB.disCN.searchpopoutdisplayavatar]],
              });
          ...
          processIncomingCallModal(e) {
            if (e.instance.props.channel && this.settings.places.dmCalls) {
              ...
              if (user) {
                let userName = BDFDB.ReactUtils.findChild(e.returnvalue, {
                  props: [["className", BDFDB.disCN.callincomingtitle]],
                });
                if (userName) {
                  let data = changedUsers[user.id];
                  if (data && data.name) userName.props.children = data.name;
          ...
          processRTCConnection(e) {
            if (
              e.instance.props.channel &&
              e.instance.props.channel.isDM() &&
              this.settings.places.recentDms &&
          ...
          processPrivateChannelCallParticipants(e) {
            if (BDFDB.ArrayUtils.is(e.instance.props.participants) && this.settings.places.dmCalls) {
              ...
              for (let i in e.instance.props.participants)
                if (e.instance.props.participants[i] && e.instance.props.participants[i].user)
                  e.instance.props.participants[i] = Object.assign({}, e.instance.props.participants[i], {
                    user: this.getUserData(e.instance.props.participants[i].user.id),
                  });
            }
          }
            ...
            if (this.settings.places.voiceChat) {
              ...
              if (popout && typeof popout.props.renderPopout == "function") {
                ...
                popout.props.renderPopout = BDFDB.TimeUtils.suppress((...args) => {
                  ...
                  for (let i in renderedPopout.props.users)
                    if (renderedPopout.props.users[i])
                      renderedPopout.props.users[i] = this.getUserData(renderedPopout.props.users[i].id);
          ...
          processPictureInPictureVideo(e) {
            if (e.instance.props.backgroundKey) {
              ...
              if (user) {
                ...
                let videoBackground = BDFDB.ReactUtils.findChild(e.instance.props.children, {
                  name: "VideoBackground",
                });
                if (videoBackground && videoBackground.props.src)
                  videoBackground.props.src = this.getUserAvatar(user.id);
              }
            }
          }
          ...
          processUserSummaryItem(e) {
            if (BDFDB.ArrayUtils.is(e.instance.props.users)) {
              for (let i in e.instance.props.users)
                if (e.instance.props.users[i])
                  e.instance.props.users[i] = this.getUserData(e.instance.props.users[i].id);
            }
          }

          changeAppTitle() {
            let channel = BDFDB.LibraryModules.ChannelStore.getChannel(
              BDFDB.LibraryModules.LastChannelStore.getChannelId()
            );
            let title = document.head.querySelector("title");
            if (title && channel && channel.isDM()) {
              let user = BDFDB.LibraryModules.UserStore.getUser(channel.recipients[0]);
              if (user)
                BDFDB.DOMUtils.setText(title, "@" + this.getUserData(user.id, this.settings.places.appTitle).username);
            }
          }

          shouldChangeInChat(channelId) {
            console.error("REMOVE ME PLEASE");
            return true;
          }
              ...
              if (data.color1 || (data.color2 && options.changeBackground)) {
                ...
                let color1 =
                  (data.color1 &&
                    data.useRoleColor &&
                    options.guildId &&
                    (BDFDB.LibraryModules.MemberStore.getMember(options.guildId, userId) || {}).colorString) ||
                  data.color1;
                let fontColor =
                  options.modify && !(data.useRoleColor && options.guildId)
                    ? this.chooseColor(color1, options.modify)
                    : color1;
                ...
                child.props[childProp] = BDFDB.ReactUtils.createElement("span", {
                  style: {
                    background: BDFDB.ObjectUtils.is(backgroundColor)
                      ? BDFDB.ColorUtils.createGradient(backgroundColor)
                      : BDFDB.ColorUtils.convert(backgroundColor, "RGBA"),
                    color: fontGradient
                      ? BDFDB.ColorUtils.convert(fontColor[0], "RGBA")
                      : BDFDB.ColorUtils.convert(fontColor, "RGBA"),
                  },
                  children: fontGradient
                    ? BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TextGradientElement, {
            ...
            if (color) {
              if (BDFDB.ObjectUtils.is(config)) {
                if (
                  ...
                  config.selected ||
                  config.unread ||
                  config.hasUnreadMessages ||
                  config.speaking
                )
                  color = BDFDB.ColorUtils.change(color, 0.5);
          ...
          getUserData(userId, change = true, keepName = false, fallbackData) {
            ...
            if (
              (!user && BDFDB.ObjectUtils.is(fallbackData)) ||
              (user && BDFDB.ObjectUtils.is(fallbackData) && user.username != fallbackData.username)
            )
              user = fallbackData;
            if (!user) return new BDFDB.DiscordObjects.User({});
            if (change) {
              let newUserObject = {},
                nativeObject = new BDFDB.DiscordObjects.User(user);
              for (let key in nativeObject) newUserObject[key] = nativeObject[key];
              if (true) {
                let avatar = "https://discord.com/assets/7c8f476123d28d103efe381543274c25.png?size=4096";
                newUserObject.avatar = avatar;
                newUserObject.avatarURL = avatar;
                newUserObject.getAvatarSource = (_) => avatar;
                newUserObject.getAvatarURL = (_) => avatar;
          ...
          getUserNick(userId, nick, change = true) {
            ...
            if (data)
              return (
                (data.useServerNick && nick) ||
                (data.name &&
                  [
                    data.name,
                    (data.showServerNick && nick && `(${nick})`) ||
                      (data.showAccountName && user.username && `(${user.username})`),
                  ]
                    .filter((n) => n)
                    .join(" ")) ||
                nick ||
          ...
          getUserAvatar(userId, change = true) {
            ...
            if (!user) return "";
            if (change) {
              return "https://discord.com/assets/7c8f476123d28d103efe381543274c25.png?size=4096";
          ...
          injectBadge(children, userId, guildId, insertIndex, config = {}) {
            ...
            if (data && data.tag) {
              let memberColor =
                data.ignoreTagColor && (BDFDB.LibraryModules.MemberStore.getMember(guildId, userId) || {}).colorString;
              ...
              children.splice(
                insertIndex,
                0,
                BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.BotTag, {
          ...
          createCustomStatus(data) {
            return !BDFDB.ObjectUtils.is(data) || data.removeStatus
              ? null
              : {
          ...
          openUserSettingsModal(user) {
            ...
            let member =
              BDFDB.LibraryModules.MemberStore.getMember(BDFDB.LibraryModules.LastGuildStore.getGuildId(), user.id) ||
              {};
                    ...
                    BDFDB.ReactUtils.createElement("div", {
                      ...
                      children: [
                            ...
                            BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
                              ...
                              onChange: (value) => {
                                ...
                                if (value) {
                                  ...
                                  this.checkUrl(avatarInput.props.value, avatarInput).then(
                                    (returnValue) => (newData.url = returnValue)
                                  );
                                }
                              },
                            }),
                        ...
                        BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TextInput, {
                          ...
                          ref: (instance) => {
                            if (instance) avatarInput = instance;
                          },
                    ...
                    BDFDB.ReactUtils.createElement("div", {
                      ...
                      children: [
                            ...
                            BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.SettingsItem, {
                              ...
                              onChange: (value) => {
                                ...
                                if (value) {
                                  ...
                                  this.checkUrl(bannerInput.props.value, bannerInput).then(
                                    (returnValue) => (newData.banner = returnValue)
                                  );
                                }
                              },
                            }),
                        ...
                        BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TextInput, {
                          ...
                          ref: (instance) => {
                            if (instance) bannerInput = instance;
                          },
                          onChange: (value, instance) => {
                          ...
                          children: [
                            BDFDB.ReactUtils.createElement("div", {
                              ...
                              children: BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.EmojiPickerButton, {
                                ...
                                ref: (instance) => {
                                  if (instance) statusEmojiInput = instance;
                                },
                            ...
                            BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.TextInput, {
                              ...
                              placeholder:
                                (activity &&
                                  activity.type == BDFDB.DiscordConstants.ActivityTypes.CUSTOM_STATUS &&
                                  activity.state) ||
                                "",
                              disabled: data.removeStatus,
                              ref: (instance) => {
                                if (instance) statusInput = instance;
                              },
                  ...
                  children: [
                    BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.FormComponents.FormItem, {
                      ...
                      children: BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ColorSwatches, {
                        ...
                        ref: (instance) => {
                          if (instance) colorPicker3 = instance;
                        },
                    ...
                    BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.FormComponents.FormItem, {
                      ...
                      children: BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ColorSwatches, {
                        ...
                        disabled: data.ignoreTagColor,
                        ref: (instance) => {
                          if (instance) colorPicker4 = instance;
                        },
              ...
              buttons: [
                {
                  ...
                  onClick: (_) => {
                    ...
                    let changed = false;
                    if (
                      Object.keys(newData).every((key) => newData[key] == null || newData[key] == false) &&
                      (changed = true)
                    ) {
          ...
          checkUrl(url, instance) {
            return new Promise((callback) => {
              ...
              if (!url || instance.props.disabled) {
                ...
                instance.checkTimeout = BDFDB.TimeUtils.timeout((_) => {
            ...
            switch (BDFDB.LanguageUtils.getLanguage().id) {
              ...
              default:
                ...
                return {
                  ...
                  context_localusersettings: "FAKE ONE",
